					...
					<div class="row">
						<section class="4u 6u(medium) 12u$(small)">
							...
							<ul class="alt">
								...
								<li><a href="https://www.w3schools.com/">Code</a> </li>
							</ul>
						</section>
						<section class="4u 6u$(medium) 12u$(small)">
			...
			<!--				<ul class="icons">
					...
					-->		<ul class="tabular">
								<li>
									<h3>Address</h3>
									ABC Road<br>
									<a href="https://www.w3schools.com/">Code</a> 521126
								</li>
								<li>
									<h3>Mail</h3>
					...
					<ul class="copyright">
						<li>&copy; 2021 All rights reserved. Brought To You By <a href="https://www.w3schools.com/">Code</a></li>
