...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">nikhithacr@gmail.com</a><br /><br />
...
<a href="http://www.xyz" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/niki1.jpg" width=100 height=100 alt="Nikhitha" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="nikhithacr@gmail.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Nikhitha</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 123456789</h4>
		<h4 style="font-family:'typo' ">nikhithacr@gmail.com</h4>
		<h4 style="font-family:'typo' ">SJB Institute of technology</h4></div></div>
		
		<div class="row">
		<div class="col-md-4">
		 <img src="image/niki1.jpg" width=100 height=100 alt="Meghana" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="Meghana@gmail.com" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Meghana</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 123456789</h4>
		<h4 style="font-family:'typo' ">Meghana@gmail.com</h4>
		<h4 style="font-family:'typo' ">SJB Institute of technology</h4></div></div>
