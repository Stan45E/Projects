...
<a href="http://www.xyz.com" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image\niki1.jpg" width=100 height=100 alt="Nikhitha" class="img-rounded">
		 </div>
		 <div class="col-md-5" border-style:dotted>
		<a href="nikhithacr@gmail.com"color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Nikhitha</a>
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="meghana@gmail.com"color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Meghana</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 123456789</h4>
